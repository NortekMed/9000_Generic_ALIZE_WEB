<%@ Page Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="Aquapro_Optod.aspx.cs" Inherits="Optod"%>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <asp:HiddenField ID = "page_name" Value="<%$ Resources:Site.master, optod %>" Runat="Server" />
    ...
    <script type="text/javascript">
        ...
        function getData(start, stop) {
            ...
            $.ajax({
                type: "POST",
                url: "Aquapro_Optod.aspx/GetValues",
