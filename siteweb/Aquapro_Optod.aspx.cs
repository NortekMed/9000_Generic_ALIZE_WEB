...
public partial class Optod : System.Web.UI.Page
{
    static public data_type_OPTOD downloaddata;
    ...
    protected void InitField()
    {
        ...
        equipname.Value = Resources.Aquapro_Optod.equip_name.ToString();

        param0name.Value = Resources.Aquapro_Optod.param0name.ToString();
        param0label.Value = Resources.Aquapro_Optod.param0label.ToString();
        param0unit.Value = Resources.Aquapro_Optod.param0unit.ToString();

        param1name.Value = Resources.Aquapro_Optod.param1name.ToString();
        param1label.Value = Resources.Aquapro_Optod.param1label.ToString();
        param1unit.Value = Resources.Aquapro_Optod.param1unit.ToString();

        param2name.Value = Resources.Aquapro_Optod.param2name.ToString();
        param2label.Value = Resources.Aquapro_Optod.param2label.ToString();
        param2unit.Value = Resources.Aquapro_Optod.param2unit.ToString();

        param3name.Value = Resources.Aquapro_Optod.param3name.ToString();
        param3label.Value = Resources.Aquapro_Optod.param3label.ToString();
        param3unit.Value = Resources.Aquapro_Optod.param3unit.ToString();
    ...
    [System.Web.Services.WebMethod]
    public static data_type_OPTOD GetValuesFrom(string begin, string end)
    {
        Optod test = new Optod();
        test.CreateField();
        test.InitField();
    ...
    public static data_type_OPTOD GetValues(string begin, string end)
    {
        //C4E test = new C4E();
        //test.InitField();
        ...
        data_type_OPTOD data = new data_type_OPTOD();
