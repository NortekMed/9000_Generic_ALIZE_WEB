<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="Wave_courant.aspx.cs" Inherits="Wave" %>
    ...
    <script type="text/javascript">
        ...
        function getData(start, stop) {
            ...
            $.ajax({
                ...
                error : function() {
                    alert('Vagues BFI2 : erreur de chargement ou pas de données');
                }
            });
        }
