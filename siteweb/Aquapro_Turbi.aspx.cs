...
public partial class Turbi : System.Web.UI.Page
{
    static public data_type_TURBI downloaddata;
    ...
    protected void InitField()
    {
        ...
        param0name.Value = Resources.Aquapro_Turbi.param0name.ToString();
        param0label.Value = Resources.Aquapro_Turbi.param0label.ToString();
        param0unit.Value = Resources.Aquapro_Turbi.param0unit.ToString();
    ...
    [System.Web.Services.WebMethod]
    public static data_type_TURBI GetValuesFrom(string begin, string end)
    {
        Turbi test = new Turbi();
        test.CreateField();
        test.InitField();
    ...
    public static data_type_TURBI GetValues(string begin, string end)
    {
        //C4E test = new C4E();
        //test.InitField();
        ...
        data_type_TURBI data = new data_type_TURBI();
