...
public partial class Wave : System.Web.UI.Page
{
    ...
    public static dataWave GetValues(string begin, string end)
    {
        ...
        FbDataAdapter dataadapter3 = new FirebirdSql.Data.FirebirdClient.FbDataAdapter("SELECT a.TIME_REC, a.DIRTP, a.MAINDIR FROM WAVES a " + timestampsrequest + " order by a.TIME_REC", ConfigurationManager.ConnectionStrings["database1"].ConnectionString);
        ...
        foreach (DataRow dRow in myDataTable3.Rows)
        {
            ...
            list_d_mean.Add(double.Parse(dRow["MAINDIR"].ToString()));
